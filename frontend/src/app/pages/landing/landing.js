                ...
                <section className="slice py-7">
                    <div className="container">
                        <div className="row row-grid align-items-center">
                            ...
                            Silakan pilih dosbing dan login dengan akun Gmail kamu untuk melanjutkan, kalau kamu kepo sama aku silakan pilih kenalan ya.
                            </p>
                            {/* Buttons */}
                        ...
                        <div className="py-6">
                            ...
                            <div className="col-lg-5 order-lg-2">
                                ...
                                <li className="py-2">
                                    ...
                                    <div>
                                    <a href="https://github.com/fflah/reksis" target="_blank" rel="noopener noreferrer"><span className="h6 mb-0">Github repository</span></a>
                                    </div>
                                    </div>
                                </li>
                                </ul>
                ...
                <footer className="position-relative" id="footer-main">
                    ...
                    <div className="container pt-4">
                        ...
                        <div className="col-md-6">
                            ...
                            © 2021 <a href="/#" className="font-weight-bold" target="_blank">Reksis</a>. All rights reserved
                            </div>
                        </div>
                        <div className="col-md-6">
